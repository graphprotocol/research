...
#### get
#### Description
Retrieves a value by its key. The type of key and value are determined by the type of index specified. By default, `get` accepts a key of the form `<entityType>:<id>` and returns an entity.
##### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **blockHash** | `String` | The hash of the Ethereum block as of which to read the data. |
| **key** | `String` | The id of the entity to retrieve. |
| **index** | `Object` | An `IndexRecord` describing the index to use for operation. Defaults to a basic key-value index on all entities.
##### Returns
`Object | null` - The returned entity with specified fields, or `null` if no entity was found.
...
{
  "method": "get",
  "params": ["0xbf133b670857b983fc1b8f08759bc860378179042a0dba30b30e26d6f7f919d1", "User:1337"]
}
// response
{
  "result": {
...
// response
{
  // TODO: Gas should be higher since less efficient index being used for simple KV lookup.
  "gasUsed": "TODO",
  "result": {
    "firstName": "Vitalik",
    "lastName": "Buterin",
...
| ---- | ---- | ----------- |
| **blockHash** | `String` | The hash of the Ethereum block as of which to read the data. |
| **count** | 'Number' | The number of entities to retrieve.  |
